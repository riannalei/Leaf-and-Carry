          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap text-[#4D6B58]">
                ...
                <span className="font-semibold">one-of-one</span> tote bag. Leaf
                & Carry allows you to carry your memories, not just your
                essentials.
              </p>
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8 text-[#4D6B58]">
                <p>
                  "I usually carry my tote everywhere, and my last ones got worn
                  out quickly. This one, besides a barely noticeable scratch on
                  the corner,{" "}
                  <span className="p-0.5 bg-[#4D6B58] text-white">
          ...
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-[#2D3E35]">
                ...
                <span className="relative px-2 bg-[#A7B59E] text-white">
                  your own tote
                </span>{" "}
                now
              </h2>
